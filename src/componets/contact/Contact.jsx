        ...
        <div className="contact__content">
            ...
            <div className="contact__info">
                ...
                <div className="contact__card">
                    ...
                    <i className='bx bxs-right-arrow-alt contact__button-icon'></i></a>
                </div>
        ...
        <div className="contact__content">
            ...
            <form className="contact__form">
                ...
                <div className="contact__form-div">
                    ...
                    <input type="email" name="email" className="contact__form-input" placeholder = "Insert your name here..." />

                </div>

                <div className="contact__form-div contact__form-area">
                    <label htmlFor="" className="contact__form-tag">Project</label>
                    <textarea name="project"  className="contact__form-input" cols="30" rows="10" placeholder='Write your project description'>
